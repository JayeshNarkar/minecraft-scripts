...
def wheat_route(curr_x, start_z, end_z):
    ...
    move_sequence(
        ...
        {"function": move_forward_and_attack, "delay": 2.3},
    )
...
def main():
    ...
    count = 0
    start_z, end_z = 49, 142
    init_x = -47

    while True:
        count += 1
        send_discord_message(f"Starting Potato farming run #{count}", mention=False)
        ...
        move_till(move_right_and_attack, 36, end_z)
