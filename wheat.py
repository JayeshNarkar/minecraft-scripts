...
def route_loop(common_x, start_z, end_z, init_y, first_y):
    ...
    move_till(move_right_and_attack, common_x, end_z, init_y, 2)
    ...
    move_till(move_left_and_attack, common_x, start_z, first_y, 2)    
...
def main():
    ...
    while True:
        ...
        move_till(move_right_and_attack, common_x , 238, 67)        
